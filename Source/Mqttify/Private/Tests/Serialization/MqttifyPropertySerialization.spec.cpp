...
namespace Mqttify
{
	...
	{
		Describe(
			"For invalid Property Identifiers",
			[this]
			{
				TArray<uint8> InvalidIdentifiers = {0, 4, 5, 6, 7, 10, 12, 13, 14, 15, 16, 20, 27, 29, 30, 32, 43};

				for (const uint8& Identifier : InvalidIdentifiers)
				{
					It(
						FString::Printf(TEXT("Should return unknown property for %d"), Identifier),
						[this, Identifier]
						{
		...
		// For uint8
		Describe(
			"FMqttifyProperty for PayloadFormatIndicator",
			[this]
			{
				It(
					...
					[this]
					{
						...
						const FMqttifyProperty Property = FMqttifyProperty::Create<
							EMqttifyPropertyIdentifier::PayloadFormatIndicator>(Data);

						TestEqual(
							"Code should be PayloadFormatIndicator",
							Property.GetIdentifier(),
				...
				It(
					...
					{
						uint8 Data = 1;
						FMqttifyProperty OriginalProperty = FMqttifyProperty::Create<
							EMqttifyPropertyIdentifier::PayloadFormatIndicator>(Data);
						...
						TestEqual(
							"Code should be PayloadFormatIndicator after deserialization",
							DeserializedProperty.GetIdentifier(),
							EMqttifyPropertyIdentifier::PayloadFormatIndicator);

						uint8 DeserializedData;
						TestTrue(
							"Data should be valid after deserialization",
							DeserializedProperty.TryGetValue(DeserializedData) && DeserializedData == Data);
					});
			});

		Describe(
			"FMqttifyProperty for ContentType",
			[this]
			{
				It(
					"Should have the correct code",
					[this]
					{
						...
						const FMqttifyProperty Property = FMqttifyProperty::Create<
							EMqttifyPropertyIdentifier::ContentType>(Data);

						TestEqual(
							"Code should be ContentType",
							Property.GetIdentifier(),
				...
				It(
					...
					[this]
					{
						...
						TestEqual(
							"Code should be ContentType after deserialization",
							DeserializedProperty.GetIdentifier(),
							EMqttifyPropertyIdentifier::ContentType);
		...
		Describe(
			"FMqttifyProperty for MaximumQoS",
			[this]
			{
				It(
					"Should have the correct code",
					[this]
					{
						constexpr uint8 Data = 1;
						const FMqttifyProperty Property = FMqttifyProperty::Create<
							EMqttifyPropertyIdentifier::MaximumQoS>(Data);
						TestEqual(
							"Code should be MaximumQoS",
							Property.GetIdentifier(),
		...
		Describe(
			"FMqttifyProperty for RetainAvailable",
			[this]
			{
				It(
					"Should have the correct code",
					[this]
					{
						...
						TestEqual(
							"Code should be RetainAvailable",
							Property.GetIdentifier(),
		...
		Describe(
			"FMqttifyProperty for UserProperty",
			[this]
			{
				It(
					"Should have the correct code",
		...
		Describe(
			"FMqttifyProperty for MaximumPacketSize",
			[this]
			{
				It(
					"Should have the correct code",
					[this]
					{
						...
						TestEqual(
							"Code should be MaximumPacketSize",
							Property.GetIdentifier(),
		...
		Describe(
			"FMqttifyProperty for WildcardSubscriptionAvailable",
			[this]
			{
				It(
					"Should have the correct code",
					[this]
					{
						...
						TestEqual(
							"Code should be WildcardSubscriptionAvailable",
							Property.GetIdentifier(),
		...
		Describe(
			"FMqttifyProperty for SubscriptionIdAvailable",
			[this]
			{
				It(
					"Should have the correct code",
					[this]
					{
						...
						TestEqual(
							"Code should be SubscriptionIdAvailable",
							Property.GetIdentifier(),
		...
		Describe(
			"FMqttifyProperty for SharedSubscriptionAvailable",
			[this]
			{
				It(
					"Should have the correct code",
					[this]
					{
						...
						TestEqual(
							"Code should be SharedSubscriptionAvailable",
							Property.GetIdentifier(),
