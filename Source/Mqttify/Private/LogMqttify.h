 ...
 */
#define LOG_MQTTIFY_PACKET(Level, InPacket)											\
do {																				\
if (UE_LOG_ACTIVE(LogMqttify, Level))												\
{																					\
IMqttifyControlPacket& Packet = const_cast<IMqttifyControlPacket&>(InPacket);		\
 ...
 * @param InPacket The packet to print.
 */
#define LOG_MQTTIFY_PACKET_MSG(Level, Msg, InPacket)								\
do {																				\
if (UE_LOG_ACTIVE(LogMqttify, Level))												\
{																					\
IMqttifyControlPacket& Packet = const_cast<IMqttifyControlPacket&>(InPacket);		\
