...
BEGIN_DEFINE_SPEC(
	...
	const TArray<uint8> Mqtt3PubRel = {
		// Fixed header
		0x62,
		// Packet type (0x60) and Flags (0x02 for PubRel)
		0x02,
...
{
	Describe(
		"TMqttifyPebRelPacket<EMqttifyProtocolVersion::Mqtt_5>",
		[this]
		{
			It(
				...
				[this]
				{
					...
					TestPacketsEqual(TEXT("Packet should match expected"), PubRelPacket, Mqtt5PubRelNoProperties, this);
				});
			...
			It(
				"Should serialize not found with properties",
				[this]
				{
					const TTuple<FString, FString> PropertyData = MakeTuple(TEXT("test"), TEXT("test"));
					const FMqttifyProperties Properties{
			...
			It(
				"Should deserialize success with properties",
				[this]
				{
					FArrayReader Reader;
			...
			It(
				"Should deserialize not found with properties",
				[this]
				{
					FArrayReader Reader;
	...
	Describe(
		"TMqttifyPebRelPacket<EMqttifyProtocolVersion::Mqtt_3_1_1>",
		[this]
		{
			It(
				...
				[this]
				{
					...
					TestPacketsEqual(TEXT("Packet should match expected"), PubRelPacket, Mqtt3PubRel, this);
				});
			...
			It(
				...
				[this]
				{
					...
					const FMqttifyFixedHeader Header = FMqttifyFixedHeader::Create(Reader);
					const TMqttifyPubRelPacket<EMqttifyProtocolVersion::Mqtt_3_1_1> PubRelPacket(Reader, Header);

					TestEqual(TEXT("Packet Identifier should be equal"), PubRelPacket.GetPacketId(), 1);
				});
		});
}
